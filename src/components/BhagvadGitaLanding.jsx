      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex space-x-6">
            ...
            <a href="#admission" className="hover:text-amber-200 transition-colors">Admission Form</a>
    ...
    <>
      ...
      <section className="relative py-16 bg-gradient-to-r from-amber-800 via-orange-800 to-amber-900 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full">
          ...
          <div className="absolute bottom-20 left-1/4 w-12 h-12 bg-amber-400/20 rounded-full animate-pulse"></div>
        </div>
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              ...
              <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                <div className="text-3xl font-bold text-amber-800 mb-2">18</div>
                <div className="text-amber-600">Chapters</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg">
