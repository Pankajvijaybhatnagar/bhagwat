        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-amber-800 font-semibold mb-2">Academic Qualification *</label>
                <select
              ...
              {/* Photo Upload */}
              <div>
                <label className="block text-amber-800 font-semibold mb-2">Upload Photo *</label>
                <input
                  type="file"
                  name="photo"
                  onChange={handleFileChange}
                  accept="image/*"
                  className="w-full px-4 py-3 border border-amber-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-amber-100 file:text-amber-700 hover:file:bg-amber-200"
                  required
                />
                <p className="text-amber-600 text-sm mt-1">Please upload a passport-size photograph (JPG, PNG, max 2MB)</p>
              </div>

              {/* Signature Upload */}
              <div>
                <label className="block text-amber-800 font-semibold mb-2">Upload Signature *</label>
                <input
                  type="file"
                  name="signature"
                  onChange={handleFileChange}
                  ...
                  required
                />
                <p className="text-amber-600 text-sm mt-1">Please upload your signature (JPG, PNG, max 1MB)</p>
              </div>
